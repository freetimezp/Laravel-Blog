...
<div class="container-fluid">
    <div class="row fh5co-post-entry single-entry">
        <article
            ...
            <h2 class="fh5co-article-title animate-box"><a href="{{url('single')}}">My First Time Traveling in
                    Vietnam</a></h2>
            ...
            <div
                ...
                <div class="row rp-b">
                    <div class="col-lg-6 col-md-12 animate-box">
                        <figure>
                            <img src="{{url('assets/images/pic_1.jpg')}}"
                ...
                <div class="row rp-b">
                    <div class="col-lg-6 col-lg-push-6 col-md-12 col-md-push-0 animate-box">
                        <figure>
                            <img src="{{url('assets/images/pic_4.jpg')}}"
                                 alt="Free HTML5 Bootstrap Template by FREEHTML5.co" class="img-responsive">
                            <figcaption>This is a sweet image caption. Far far away, behind the word mountains, far from
                                the countries Vokalia and Consonantia
                            </figcaption>
                    ...
                    <div class="col-lg-6 col-lg-pull-6 col-md-12 col-md-pull-0 cp-r animate-box">
                        ...
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,
                            there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the
                            Semantics, a large <a
                                href="#">language</a> ocean. A small river named Duden flows by their place and supplies
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 animate-box">
                        <figure>
                            <img src="{{url('assets/images/pic_5.jpg')}}"
                                 alt="Free HTML5 Bootstrap Template by FREEHTML5.co" class="img-responsive">
                            <figcaption>This is a sweet image caption. Far far away, behind the word mountains, far from
                                the countries Vokalia and Consonantia
                            </figcaption>
                    ...
                    <div class="col-md-4 animate-box">
                        <figure>
                            <img src="{{url('assets/images/pic_6.jpg')}}"
                                 alt="Free HTML5 Bootstrap Template by FREEHTML5.co" class="img-responsive">
                            <figcaption>This is a sweet image caption. Far far away, behind the word mountains, far from
                                the countries Vokalia and Consonantia
                            </figcaption>
                    ...
                    <div class="col-md-4 animate-box">
                        <figure>
                            <img src="{{url('assets/images/pic_7.jpg')}}"
                                 alt="Free HTML5 Bootstrap Template by FREEHTML5.co" class="img-responsive">
                            <figcaption>This is a sweet image caption. Far far away, behind the word mountains, far from
                                the countries Vokalia and Consonantia
                            </figcaption>
